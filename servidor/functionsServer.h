...
#define MENSAJE_INGRESAR_USERNAME "\nIngrese su nombre de usuario:"
#define MENSAJE_INGRESAR_CONTRASENIA "\nIngrese su contrasenia:"
#define MENSAJE_BIENVENIDA "\n\nBienvenido al servidor de traduccion."
#define MENSAJE_INGRESAR_COMANDO "\n¿Qué desea hacer?:"
#define MENSAJE_PEDIDO_PALABRA_A_TRADUCIR "\n¿Que palabra quiere traducir?:"
#define MENSAJE_SUBMENU_USUARIOS "\n¿Quiere dar de alta un usuario o debloquearlo?:"
#define MENSAJE_CON_TRADUCCION "\n%s en ingles es %s en espaniol."
...
#define MENSAJE_ELEGIR_DESBLOQUEAR_USUARIO "\n¿Cual usuario quiere desbloquear?:"
...
#define MENU_BASE_NUEVA_TRADUCCION "\nInsertar nueva traduccion --> /NUEVA_TRADUCCION"
#define MENU_BASE_USERS "\nAdministracion de usuarios -> /USERS"
#define MENU_BASE_ACTIVIDADES "\nRegistro de actividades ----> /ACTIVIDADES"
#define MENU_BASE_LOGOUT "\nCerrar sesion --------------> /LOGOUT"
#define MENU_BASE_APAGAR "\nApagar servidor ------------> /APAGAR"


#define MENU_SUBMENU_USUARIOS_ALTA "\n\nAlta de nuevos usuarios ---> /ALTA"
#define MENU_SUBMENU_USUARIOS_DESBLOQUEO "\nDesbloqueo de usuario -----> /DESBLOQUEO" 
#define MENU_SUBMENU_USUARIOS_SALIR "\nVolver al menu anterior ---> /SALIR"
